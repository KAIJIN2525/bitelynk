    ...
    <div className="bg-gradient-to-br from-[#1a120b] via-[#2a1e14] to-[#3e2b1d] min-h-screen py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-center mb-12 bg-clip-text text-transparent bg-gradient-to-r from-amber-200 via-amber-300 to-amber-200">
          ...
          <div className="block text-xl sm:text-2xl md:text-3xl font-cinzel mt-4 text-amber-100/80">
            Symphony of Flavors
          </div>
        </h2>
        ...
        {loading ? (
          <div className="flex justify-center items-center py-20">
            <div className="text-center">
              ...
              <p className="text-amber-100 font-cinzel">
                        ...
                        <div className="flex items-center gap-2">
                          {quantity > 0 ? (
                            ...
                            <button
                              ...
                              className="bg-amber-900/40 px-4 py-1.5 rounded-full font-cinzel text-xs uppercase sm:text-sm tracking-wider transition-transform duration-300 hover:scale-110 shadow-lg hover:shadow-amber-900/20 relative overflow-hidden border border-amber-800/50 "
                            >
