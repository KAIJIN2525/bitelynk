...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1a120b] via-[#3c2a21] to-[#1a120b] overflow-hidden relative ">
      ...
      >
        <div className="max-w-4xl mx-auto">
          <motion.h1 className="text-5xl sm:text-6xl md:text-7xl font-bold font-serif text-transparent mb-4 bg-clip-text bg-gradient-to-r from-amber-500 to-yellow-600">
            Culinary Express
          </motion.h1>
          <motion.p
            className="text-lg sm:text-xl md:text-2xl font-playfair italic text-amber-200 mb-8"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          >
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
          {features.map((f, i) => {
            ...
            return (
              ...
              >
                <div className="absolute -inset-1 bg-gradient-to-br from-amber-600/30 to-amber-500/30 rounded-lg blur-lg opacity-50 group-hover:opacity-80 transition-all duration-300" />
                ...
                <div className=" relative bg-[#3c2a21]/90 backdrop-blur-lg rounded-3xl overflow-hidden border border-amber-600/30 hover:border-amber-500 transition-all duration-300 h-full">
                  ...
                  <div className="p-8">
                    ...
                    <h3 className="text-2xl font-bold b-2 text-amber-100">
                      {f.title}
                    </h3>
          ...
          {stats.map((stat, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div className="relative h-full bg-[#3c2a21]/40 backdrop-blur-lg rounded-xl border-2 border-amber-600/30 overflow-hidden transition-all duration-300">
                    <motion.div
                    ...
                    <div className="relative z-10 h-full flex flex-col items-center justify-center">
                      ...
                      <div className="text-4xl font-bold tracking-widest bg-clip-text bg-gradient-to-r from-amber-200 to-amber-400 text-transparent">
                        {stat.number}
                      </div>
                      <motion.div
