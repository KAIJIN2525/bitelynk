      ...
      <div className="bg-gradient-to-br from-amber-900 via-amber-800 to-amber-700 text-white py-16 px-4 sm:px-8 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 relative z-10">
          ...
          <div className="flex-1 space-y-8 relative md:pr-8 lg:pr-19 text-center md:text-left">
            ...
            >
              <div className="relative flex items-center bg-amber-900/30 rounded-full border-2 border-amber-500/30 shadow-2xl hover:bg-amber-400/50 transition-all duration-300">
                ...
                <input
                  ...
                  className="w-full py-4 pr-6 bg-transparent outline-none placeholder:text-amber-200/70 placeholder:text-base
              sm:placeholder:text-lg text-lg font-medium tracking-wide"
                />
                <button type="submit" className="mr-3 px-6 py-3 bg-gradient-to-r from-amber-400 to-amber-300 rounded-full font-semibold text-amber-900 hover:from-amber-300 hover:to-amber-200 transition-all duration-300 shadow-lg hover:shadow-amber-300/20">
                  Search
                </button>
              </div>
            </form>
